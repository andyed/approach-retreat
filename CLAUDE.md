...
- Mark values with their source: "(NB21:K3, post coordinate-space audit 2026-04-09)"
...
- **direction_changes:** was a scroll artifact (went to zero post coordinate-space fix). Removed from feature set.
